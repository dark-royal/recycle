import maps from '/home/michael/recycle/src/Components/asset/Screenshot 2023-09-23 152338 1.png'
import link1 from '/home/michael/recycle/src/Components/asset/Link (1).png'
import link2 from '/home/michael/recycle/src/Components/asset/Link (2).png'
import link3 from '/home/michael/recycle/src/Components/asset/Link (3).png'
...
const Flame = () => {
    return (
        ...
        <div className="bg-white rounded-2xl p-20">
            <div>
                <h2 className="text-green-500 ml-4 md:ml-[120px] font-thin text-2xl md:text-3xl mt-3">
