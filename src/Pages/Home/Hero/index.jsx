...
const Hero = () => {
    return (
        <>
            <div className="bg-customGreen mt-[10px] h-[400px] flex flex-col md:flex-row justify-center items-center px-4 md:px-0">
                <div className="md:text-left">
                    ...
                    <div>
                        <p className="text-white md:ml-[90px] text-left">
                            ...
                            G-Cycle collection center, Learn About the Impact, and Earn <br />
