        ...
        <div className="p-5 md:p-20 bg-customGreen">
            <div className="flex flex-col md:flex-row">
                <div className="flex flex-col md:flex-row ml-4 md:ml-20 gap-5">
                    <div className="-mb-24 -ml-14">
                        <img
                            src={image}
                            alt=""
                            className="w-1/4 md:w-full md:h-[10%]"
                        />
                        {/*<p className="text-white text-sm md:text-sm mt-2 md:mt-8">G-cycle</p>*/}
                    </div>
            ...
            <div className="flex justify-center md:justify-end ml-0 md:ml-[90%] gap-4">
                ...
                <a href="https://www.instagram.com/banksmichael48?igsh=YzljYTk1ODg3Zg== " target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://www.linkedin.com/in/timileyin-akin-elusoji-90766511a?trk=contact-info" target="_blank" rel="noopener noreferrer">
