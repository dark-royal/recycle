    ...
    return (
        <>
            <div className="bg-customGreen text-white flex flex-col md:flex-row mt-15 justify-center items-center p-4">
                <div className="mb-[150px] text-center md:text-left md:ml-[160px]">
                    <h2 className="font-semibold mt-[30%] text-2xl md:text-3xl">
                        What will <br /> you get by <br /> giving away <br /> your waste
                    </h2>
                    <button className="text-green-500 hover:bg-white bg-white p-4 rounded-2xl mt-5 md:mt-10">
                        Learn More
                    </button>
                </div>

                {/* Container for images and text */}
                <div className="flex flex-col md:flex-row md:ml-[180px] space-y-10 md:space-y-0 md:space-x-[50px] mt-10 mb-10 justify-center items-center">
                    ...
                    <div className="text-center justify-center">
                        <img src={image3} alt="image3" className="w-[150px] md:w-[200px] mx-auto md:ml-10" />
