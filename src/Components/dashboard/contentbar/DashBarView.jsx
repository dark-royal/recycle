...
const DashBarView = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-start min-h-screen p-4 md:p-6" style={{ width: '80%', maxWidth: '80vw', margin: '0 auto' }}>
            ...
            <div className="flex flex-wrap mt-6 md:mt-10 gap-2 md:gap-8 justify-center">
                <div className="p-2 bg-white w-28 h-20 md:w-48 md:h-36 shadow-md flex flex-col items-center rounded-full">
                ...
                <div className="p-2 bg-white w-28 h-20 md:w-48 md:h-36 shadow-md flex flex-col items-center rounded-full">
                    ...
                    <p className="text-green-500 text-xs md:text-sm">Cash</p>
                    <p className="text-green-500 font-bold text-sm md:text-lg">₦ 0.0</p>
                </div>
                <div className="p-2 bg-white w-28 h-20 md:w-48 md:h-36 shadow-md flex flex-col items-center rounded-full">
