        ...
        <div className="flex flex-col items-center justify-start min-h-screen p-6 ">
            ...
            <div className="flex mt-10 mr-48 gap-12">
                <div className="p-6 bg-white w-52 h-40 shadow-md flex flex-col items-center"
                    ...
                    <p className="text-green-500 font-bold">₦ 2500</p>
                </div>
                <div className="p-6 bg-white w-52 h-40 shadow-md flex flex-col items-center"
                     style={{borderRadius: '90px'}}>
                    <img src={image2} alt="transfer" className="mb-2"/>
                    <p className="text-green-500">Cash</p><br/>
                    <p className="text-green-500 font-bold">₦ 700</p>
                </div>
                <div className="p-6 bg-white w-52 h-40 shadow-md flex flex-col items-center"
                     style={{borderRadius: '90px'}}>
            ...
            <div className="flex flex-row mt-10 mr-5 -ml-64 gap-4">
                <div className="p-4 bg-customWhite w-80 shadow-md flex flex-col items-baseline rounded-md">
                    <p className="flex gap-32 font-extralight">E-Waste Collected <span><img src={image5} alt=""/></span></p>
                </div>
                <div className="p-4 bg-customWhite w-80 shadow-md flex flex-col items-baseline rounded-md">
                    <p className="flex gap-32 font-extralight">Your Contribution<span><img src={image6} alt=""/></span></p>
                </div>
            </div>
        </div>
    );
